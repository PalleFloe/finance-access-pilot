      ...
      <div className="container mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-100 shadow-sm mt-12">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            <div>
              <h4 className="text-lg font-semibold text-brand-blue mb-3">What We Provide</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold text-brand-blue mb-3">Why It Matters</h4>
              <p className="text-lg text-slate-600 leading-relaxed">
            ...
            <div>
              <h4 className="text-lg font-semibold text-brand-blue mb-3">Who Benefits</h4>
              <p className="text-lg text-slate-600 leading-relaxed">
            ...
            <div>
              <h4 className="text-lg font-semibold text-brand-blue mb-3">How Models works</h4>
              <p className="text-lg text-slate-600 leading-relaxed">
