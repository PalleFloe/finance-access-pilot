    ...
    <section id="toolbox" className="py-16 bg-slate-50">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-[32px] text-slate-600 max-w-6xl mx-auto leading-relaxed">
          ...
          <p className="text-[32px] text-slate-600 max-w-6xl mx-auto italic mt-4 leading-relaxed">
