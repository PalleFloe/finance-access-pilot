    ...
    <section id="toolbox" className="py-16 px-6 bg-slate-50">
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-[18pt] text-slate-600 max-w-5xl mx-auto leading-relaxed">
          ...
          <p className="text-[18pt] text-slate-600 max-w-5xl mx-auto italic mt-4 leading-relaxed">
