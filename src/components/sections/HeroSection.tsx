    ...
    <section className="py-16">
      <div className="container mx-auto text-center px-6">
        ...
        <p className="font-garamond text-[32px] font-normal text-slate-600 mb-6 mx-auto leading-[1.4]">
          And struggling with time-consuming, inflexible, overly complex and unreliable financial models<br />
          that don't give you the clarity to make the right decisions?
        </p>
        <h2 className="font-garamond text-[36px] font-bold text-brand-blue mb-4 mx-auto leading-[1.3]">
