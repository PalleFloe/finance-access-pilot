  ...
  return (
    <section className="py-8 md:py-16">
      <div className="container mx-auto text-center px-6">
        ...
        <p className="font-garamond text-xl sm:text-2xl md:text-3xl lg:text-4xl font-normal text-slate-600 mb-10 mx-auto leading-[1.4] max-w-4xl">
          Turn Complex Choices into Better Business Decisions
        </p>
        <h2 className="font-garamond text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-brand-blue mx-auto leading-[1.3] max-w-5xl">
