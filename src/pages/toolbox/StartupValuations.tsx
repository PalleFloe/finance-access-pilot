              ...
              <Link key={model.name} to={model.href} className="group">
                <Card className="shadow-lg border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative flex flex-col h-full min-h-[240px] cursor-pointer" style={{ backgroundColor: '#326496' }}>
                  ...
                  <CardHeader className="flex-grow p-6">
                    <CardTitle className="text-2xl font-semibold mb-3" style={{ color: model.name === "SaaS Unit Economics Model" ? '#FFFFFF' : '#FFB445' }}>
                      <span>{model.name}</span>
                    </CardTitle>
                    <div className="flex-grow text-lg leading-[1.4] font-normal" style={{ color: model.name === "SaaS Unit Economics Model" ? 'rgba(255, 255, 255, 0.75)' : 'rgba(255, 180, 69, 0.8)' }}>
