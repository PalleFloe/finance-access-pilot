  ...
  return (
    <div className="min-h-screen bg-gray-50 font-garamond">
      <Helmet>
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Decision Analysis for Venture Capital - Systematic Investment Framework | Financial Decision Models" />
        <meta property="og:description" content="Venture capital decision analysis model with systematic risk assessment and probability-weighted returns. Excel tool for VC investment evaluation. Try free online, download full version." />
        <meta property="og:url" content="https://www.financialdecisionmodels.com/toolbox/startup-valuations/decision-analysis" />
          ...
          <div className="flex-shrink-0 w-full max-w-md">
            <Card className="shadow-lg border-slate-200 lg:h-[240px]">
              ...
              <CardContent className="space-y-6 pb-4 pt-6">
                <Button 
                  onClick={() => openModel('https://financialdecisionmodels.sharepoint.com/:x:/s/FinancialDecisionModelsSite/EcLaZjO6V4lOmp-0KbgX264B4yjjMwYE_O_IHfKBqKA-og?e=CXRnPm&action=embedview&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=False')}
                ...
                <DownloadButton 
                  sharePointUrl="https://financialdecisionmodels.sharepoint.com/:x:/s/FinancialDecisionModelsSite/EcLaZjO6V4lOmp-0KbgX264B4yjjMwYE_O_IHfKBqKA-og?e=CXRnPm&download=1"
