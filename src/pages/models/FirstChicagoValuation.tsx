...
const FirstChicagoValuation = () => {
  ...
  const downloadModel = () => {
    ...
    link.href = 'https://financialdecisionmodels.sharepoint.com/:x:/s/FinancialDecisionModelsSite/EdGyHPuTzztMovL18ne-KSQBVHGsWOz8FdIcTxH8IhGyPQ?e=qkbaJT'
    link.target = '_blank'
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 font-garamond">
      ...
      <div className="py-12 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <h3 className="text-xl font-bold text-heading mb-6">First Chicago Valuation Model Introduction</h3>
