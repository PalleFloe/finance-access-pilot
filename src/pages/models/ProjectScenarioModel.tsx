          ...
          <Card className="shadow-lg border-slate-200 mb-8 max-w-md">
            ...
            <CardContent className="space-y-2">
              <div className="tier-buttons-stacked">
                <button className="tier-btn tier-1-btn" onClick={() => openModel('https://financialdecisionmodels.sharepoint.com/:x:/s/FinancialDecisionModelsSite/EV_koGzK1NFLhkWrMJBNojcBeEfklR1uufLXYGAuK1pUtg?e=NmO2ag')}>
                  Online & Free
                </button>
                <button className="tier-btn tier-2-btn" onClick={() => openTier2Registration('Simple Project Scenario Model')}>
                  Download & Free
                </button>
              </div>
