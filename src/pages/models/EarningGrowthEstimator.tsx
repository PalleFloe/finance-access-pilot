...
const EarningGrowthEstimator = () => {
  ...
  const softwareJson = getModelSoftwareJson({
    name: "Earning Growth Estimator – Excel Tool",
    description: "Excel earning growth estimation model. Free online preview and downloadable template with clear guidance.",
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-garamond">
      <Helmet>
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Earning Growth Estimator - ROC-Based Growth Analysis | Financial Decision Models" />
        <meta property="og:description" content="Earning growth estimator based on return on capital and reinvestment analysis. Excel model calculates sustainable growth rates for existing and new investments. Try free online or download." />
        <meta property="og:url" content="https://www.financialdecisionmodels.com/toolbox/financial-fundamentals/earning-growth-estimator" />
